...
- [interview-lab](workspaces/apps/interview-lab/) — a small NestJS workspace for independent interview experiments, with optional PostgreSQL/Redis containers and Docker/AWS practice guides.
