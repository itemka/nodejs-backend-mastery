...
- [x] Configure Vitest and a `test` script in shop-mvc-express. (Phase 1)
- [x] Add the first passing unit test to shop-mvc-express. (Phase 1)
- [x] Unit-test the shop's Zod product-form validation. (Phase 1)
- [x] Unit-test the shop's central error middleware. (Phase 1)
- [ ] Unit-test HTML escaping for product titles, validation messages, and error-page values. (Phase 1) —
      product-title escaping is covered; validation-message and error-page-value escaping are not yet.
